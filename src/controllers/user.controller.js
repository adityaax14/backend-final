...
const refereshAccessToken=asyncHandler(async(req,res)=>{
  ...
  const getCurrentUser= asyncHandler(async(req,res)=>{
    return res.status(200).jsom(200,req.user,"current user fetched sucessfully")
  })
...
export {registerUser,loginUser,logoutUser,refereshAccessToken,changeCurrentPassword,getCurrentUser,updateAccountDetails,updateUserAvatar,updateUserCoverImage,getUserChannelProfile,getWatchHistory}